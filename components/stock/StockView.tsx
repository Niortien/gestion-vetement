...
export function StockView() {
  ...
  return (
    <PageWrapper>
      <div className="rounded-xl border border-border/80 bg-[linear-gradient(120deg,rgba(240,180,41,0.14),rgba(143,126,245,0.08))] p-4 md:p-5">
        <div className="flex items-end justify-between">
          <h1 className="font-[var(--font-display)] text-2xl md:text-4xl">Stock</h1>
          <span className="rounded-full border border-accent/40 bg-[color:rgba(240,180,41,0.16)] px-3 py-1 font-[var(--font-mono)] text-accent">
            {total} variantes
          </span>
        </div>
      </div>
