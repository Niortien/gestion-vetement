...
export function ProduitsView() {
  ...
  return (
    <PageWrapper>
      ...
      <Button
        isIconOnly
        className="fixed bottom-6 right-6 z-[1000] h-12 w-12 rounded-full border border-accent/70 bg-[linear-gradient(135deg,#ffd447,#d0ae37)] text-black shadow-glow-yellow"
