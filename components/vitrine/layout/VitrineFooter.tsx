...
const FOOTER_LINKS = [
  { group: "Shop", items: [{ href: "/catalogue", label: "Catalogue" }, { href: "/lookbook", label: "Lookbook" }] },
  { group: "Info", items: [{ href: "/marque", label: "La Marque" }, { href: "/marque#contact", label: "Contact" }] },
];
        ...
        <div className="grid grid-cols-2 gap-12 md:grid-cols-4">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <a
              ...
              className="mt-4 inline-flex items-center gap-2 rounded-full border px-4 py-2 text-sm font-semibold transition-colors hover:bg-[#25D366] hover:text-black hover:border-[#25D366]"
