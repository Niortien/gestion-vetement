...
const SOCIALS = [
  ...
  },
  {
    ...
    handle: "@riviere.sn",
    color: "#E1306C",
    href: "https://instagram.com/riviere.sn",
    icon: (
      <svg width="36" height="36" viewBox="0 0 24 24" fill="currentColor">
  ...
  },
  {
    ...
    handle: "@riviere.sn",
    color: "#EFF6FF",
    href: "https://tiktok.com/@riviere.sn",
    icon: (
      <svg width="36" height="36" viewBox="0 0 24 24" fill="currentColor">
    ...
    >
      <div className="mx-auto max-w-5xl px-5 md:px-16">
        ...
        >
          Follow the
          <br />
          <span style={{ color: "var(--v-lime)" }}>Riviere</span>
        </motion.h2>
          ...
          {submitted ? (
            ...
            >
              <p className="text-sm font-black" style={{ color: "var(--v-lime)" }}>
                Bienvenue dans la famille Riviere ✓
              </p>
            </motion.div>
          ) : (
