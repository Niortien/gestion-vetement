      ...
      <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-6 px-5">
        <div>
          ...
          <p className="mt-1 text-sm" style={{ color: "var(--v-muted)" }}>
            Écris-nous directement. On vérifie le stock en temps réel.
          </p>
        </div>
        <a
          href={url}
          ...
          className="inline-flex items-center gap-2 rounded-xl px-5 py-3 text-sm font-black uppercase tracking-wider transition-opacity hover:opacity-90"
